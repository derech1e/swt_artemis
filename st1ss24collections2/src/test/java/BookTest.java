...
public class BookTest {
	...
	public void getTitleShouldReturnEmptyString() {
		Assertions.assertEquals("", book3.getTitle(),
	...
	public void sameBooksShouldBeEqual() {
		Assertions.assertEquals(book1, book1);
		Assertions.assertEquals(book2, book2);
		Assertions.assertEquals(book3, book3);
	}

	@Test
	public void bookShouldBeEqualWhenIsbnIsEqual() {
		Assertions.assertEquals(book1, new Book("123-1-11"));
		Assertions.assertEquals(book1, new Book("123-1-11", "some value", "some value"));
		Assertions.assertEquals(book2, new Book("123-1-12"));
		Assertions.assertEquals(book2, new Book("123-1-12", "some value", "some value"));
		Assertions.assertEquals(book3, new Book("123-1-13"));
		Assertions.assertEquals(book3, new Book("123-1-13", "some value", "some value"));
	}

	@Test
	public void hashCodeShouldBeEqualWhenIsbnIsEqual() {
		Assertions.assertEquals(book1.hashCode(), new Book("123-1-11").hashCode());
		Assertions.assertEquals(book1.hashCode(), new Book("123-1-11", "some value", "some value").hashCode());
		Assertions.assertEquals(book2.hashCode(), new Book("123-1-12").hashCode());
		Assertions.assertEquals(book2.hashCode(), new Book("123-1-12", "some value", "some value").hashCode());
		Assertions.assertEquals(book3.hashCode(), new Book("123-1-13").hashCode());
		Assertions.assertEquals(book3.hashCode(), new Book("123-1-13", "some value", "some value").hashCode());
	}
	...
	public void bookShouldNotBeEqualWhenIsbnIsDifferent() {
		...
		Assertions.assertNotEquals(book1, new Book("321-1-12", "Some Author", "Some Title"));
	}
	...
	public void notEqualToNonBookObjects() {
	    ...
	    try {
	        Assertions.assertFalse(book1.equals(nonBookObject));
	...
	public void toStringShouldReturnCorrectValue() {
		Assertions.assertEquals("Some Title by Some Author (ISBN 123-1-11)", book1.toString());
		Assertions.assertEquals("Another Title by Another Author (ISBN 123-1-12)", book2.toString());
	}
}
