...
public class EnglishAuctionTest extends AuctionTestBase {
    @Override
    @BeforeEach
    public void setUp() {
        super.setUp();
    ...
    @Test
    public void testEnglishAuctionSuperclass() {
        Assertions.assertEquals(Auction.class, EnglishAuction.class.getSuperclass(),
                "EnglishAuction should be a subclass of Auction!");
    }

    @Test
    public void testEnglishAuctionGenerateItemStringNullArgument() {
        try {
            auction.generateItemString(null);
            Assertions.fail("Auction.generateItemString() should throw a NullPointerException if the argument is null!");
        } catch (NullPointerException e) {
        }
    }

    @Test
    public void testEnglishAuctionGenerateItemListString() {
    ...
    @Test
    public void testEnglishGenerateItemString() {
        for (Item item : List.of(socks, book, clock)) {
            auction.registerItem(item);
        }
        ...
        for (Entry<String, Item> entry : expectedItemStringsBeforeBidding.entrySet()) {
            ...
            Assertions.assertEquals(expectedString, auction.generateItemString(item).trim(), "EnglishAuction.generateItemString() should return the correct String!");
        };
