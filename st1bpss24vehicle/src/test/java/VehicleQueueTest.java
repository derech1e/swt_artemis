...
public class VehicleQueueTest {
    ...
    public void testImplementsObserver() {
        Assertions.assertTrue(ClockObserver.class.isAssignableFrom(VehicleQueue.class),
                "The class VehicleQueue should implement ClockObserver!");
    }
    ...
    public void testConstructorNullArgument() {
        try {
            ...
            Assertions.fail("VehicleQueue.VehicleQueue() should throw a NullPointerException if the generator argument is null!");
    ...
    public void testConstructorIllegalArgument() {
        try {
            ...
            Assertions.fail("VehicleQueue.VehicleQueue() should throw an IllegalArgumentException if the entryDelay argument is zero!");
        } catch (IllegalArgumentException e) {
        }

        try {
            new VehicleQueue(-Double.MIN_VALUE, 1, 20, new VehicleGenerator());
            Assertions.fail("VehicleQueue.VehicleQueue() should throw an IllegalArgumentException if the entryDelay argument is negative!");
        } catch (IllegalArgumentException e) {
        }

        try {
            new VehicleQueue(1, 0, 20, new VehicleGenerator());
            Assertions.fail("VehicleQueue.VehicleQueue() should throw an IllegalArgumentException if the exitDelay argument is zero!");
        } catch (IllegalArgumentException e) {
        }

        try {
            new VehicleQueue(1, -Double.MIN_VALUE, 20, new VehicleGenerator());
            Assertions.fail("VehicleQueue.VehicleQueue should throw an IllegalArgumentException if the exitDelay argument is negative!");
        } catch (IllegalArgumentException e) {
        }
        ...
        try {
            ...
            Assertions.fail(
                    "VehicleQueue.VehicleQueue() should throw an IllegalArgumentException if the trafficLightRate argument is zero!");
        } catch (IllegalArgumentException e) {
        }

        try {
            new VehicleQueue(0.5, 1, -1, new VehicleGenerator());
            Assertions.fail("VehicleQueue.VehicleQueue() should throw an IllegalArgumentException if the trafficLightRate argument is is negative!");
        } catch (IllegalArgumentException e) {
        }
    }
    ...
    public void testEnterAndLeave() {
        ...
        Assertions.assertEquals(0, queue.getSize(), "VehicleQueue.getSize() should return 0 after initialization!");
        queue.enter();
        Assertions.assertEquals(1, queue.getSize(), "VehicleQueue.enter() should increase the size of the queue!");
        queue.enter();
        queue.enter();
        Assertions.assertEquals(3, queue.getSize(), "VehicleQueue.enter() should increase the size of the queue!");
        queue.leave();
        Assertions.assertEquals(2, queue.getSize(), "VehicleQueue.leave() should decrease the size of the queue!");
        queue.leave();
        queue.leave();
        Assertions.assertEquals(0, queue.getSize(), "VehicleQueue.leave() should decrease size of the queue!");
        queue.leave();
        Assertions.assertEquals(0, queue.getSize(), "VehicleQueue.leave() should not change the size of the queue if it is empty!");
    }
    ...
    public void testLength() {
        ...
        while (vehiclesToProvide.get(0) != null) {
            ...
            queue.enter();
            Assertions.assertEquals(currentLength, queue.getLength(), 0.0001, "VehicleQueue.getLength() should return the correct value!");
        }
    ...
    public void testTick() {
        for (VehicleQueueTestData testData : testDataList) {
            ...
            for (int time = 1; time <= testData.getQueueSizeValues().length; time++) {
                queue.tick(time);
                Assertions.assertEquals(testData.getQueueSizeValues()[time - 1], queue.getSize(), "VehicleQueue.tick(…) should change the size of the queue correctly!\n"
